...
const InstructorsSection: React.FC = () => {
  ...
  // Определяем количество карточек на экране в зависимости от размера
  ...
  const maxSlides = instructors.length - 1;
          ...
          <div className="overflow-hidden rounded-2xl">
            <div 
              ...
              style={{ 
                ...
                width: `${instructors.length * (100 / cardsPerView)}%`
              }}
            >
              {instructors.map((instructor) => (
                <div 
                  ...
                  style={{ width: `${100 / instructors.length}%` }}
                >
